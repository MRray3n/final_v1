...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Liste des vacances</h3>
		<div class="card-tools">
			<a href="?page=vacation/manage" class="btn btn-flat btn-info"><span class="fas fa-plus"></span>  Créer un nouveau</a>
		</div>
	</div>
	<div class="card-body">
		<div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT id,vacation_name, vacation_date FROM `vacation` ORDER BY vacation_name ASC");
							...
							<td align="center">
				                ...
				                <span class="sr-only">Basculer la liste déroulante</span>
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=vacation/manage_update&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Modifier</a>
...
<script>
  ...
  function delete_vacation(id) {
    start_loader();
    $.ajax({
      url: _base_url_ + "classes/Master.php?f=delete_vacation",
      method: "POST",
      data: { id: id },
      error: err => {
        console.log(err);
